...
[🗜️ Прикладная математика для анализа данных: оптимизация, матрицы, тензоры.](https://merkulov.top/Teaching/Optimization_methods/Прикладная_математика_для_анализа_данных__оптимизация,_матрицы,_тензоры.)
...
[💍 Прикладная математика для анализа данных: оптимизация, матрицы, тензоры](https://merkulov.top/Teaching/Optimization_methods/Прикладная_математика_для_анализа_данных__оптимизация,_матрицы,_тензоры)

[🧇 Introduction to stochastic optimization for large-scale problems](https://merkulov.top/Teaching/Optimization_methods/Introduction_to_stochastic_optimization_for_large-scale_problems)
...
[🚇 Optimization methods](https://merkulov.top/Teaching/Optimization_methods/Optimization_methods______)

[🛵 Optimization methods](https://merkulov.top/Teaching/Optimization_methods/Optimization_methods_______)
